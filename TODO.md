...
- Add statistics for which strategy rules are being passed and violated.
- Add a statistics view grouped by strategy rule, hand type, dealer upcard, and action.
- Bias future hands toward rules the player is struggling with.
- Split configuration into table rules and strategies.
- Store table rules as JSON files under a table-rules folder.
